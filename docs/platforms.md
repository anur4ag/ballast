...
On macOS, Ballast throttles agent builds during CPU saturation through reversible external DARWIN_BG policy, which lowers both their CPU and disk I/O priority.
